    ...
    <ScrollView style={styles.container}>
      <View style={{ $$css: true, _: "w-full max-w-[1024px] mx-auto" }}>
        <View
          style={{
            $$css: true,
            _: "flex-col md:flex-row grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 bg-white rounded-lg p-3",
          }}
        >
          <View>
            <ImageBackground
        ...
        >
          <View
            style={{ $$css: true, _: "bg-white rounded-lg px-3 py-5 my-2" }}
          >
            <Typography
            ...
            <IconBlock
              icon={{
                ...
                noBorder: true,
                label:
                  "No minimum purchase—delivered to your door fast & free.",
                textStyle: {
                  fontSize: 18,
                  fontWeight: "400",
                  color: "#374151",
          ...
          >
            ...
            <IconBlock
              icon={{
                ...
                noBorder: true,
                label:
                  "Eco-friendly, cruelty-free, and safe for sensitive skin.",
                textStyle: {
                  fontSize: 18,
                  fontWeight: "400",
                  color: "#374151",
